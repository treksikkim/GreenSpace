...
import { CircleArrowRight, HandPlatter, Headset } from "lucide-react";
    ...
    <div className="space-y-16">
      ...
      <section className="font-jost wrapper space-y-8">
        <div className="text-center mb-16">
          <div className="inline-block">
            ...
            <h2 className="max-sm:text-3xl md:text-5xl font-bold mb-4 relative max-sm:mb-0">
      ...
      <section className="font-jost">
        <div className="flex items-start max-h-[35rem] min-h-[35rem] overflow-hidden max-sm:flex-col max-sm:max-h-max">
          <div className="relative min-w-[60%] h-full max-w-[60%] overflow-hidden max-sm:w-full max-sm:max-w-max">
            <Image
              className="size-full max-h-[35rem] min-h-[35rem]  object-cover"
              src={"/our-works.jpg"}
              alt="Our Works"
              height={1200}
              width={1200}
            />
            <div className="absolute inset-0 black-overlay-to-top flex items-end p-10">
              <h2 className="text-2xl text-white">2 BHK Designs</h2>
            </div>
          </div>
          <div className="bg-primary relative min-w-[40%] min-h-[35rem] p-10 flex flex-col justify-center">
            ...
            <h3 className="text-white">2 BHK Interior Designs</h3>

            <div className="mt-3.5 space-y-2.5 text-gray-200">
              <p className="font-libre text-[15px] tracking-wide">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                Perferendis neque voluptatum alias mollitia excepturi? Debitis
                commodi, architecto non temporibus ea sunt earum facilis dolores
                blanditiis. Magni laudantium doloremque non consequuntur.
              </p>
              <p className="font-libre text-[15px] tracking-wide">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit.
            ...
            <OpenGetQuoteDialog isOpen className="mt-10">
              <Button className="flex items-center gap-3.5 bg-secondary">
                <Headset size={15} />
